;------------------------------------------------------------------------------
pro ppxf_gnirs,lambda,spec,var,fwhm,OUTRV=outrv,OUTDISP=outdisp,OUTSOL=sol,DOERROR=doerror,OUTERROR=outerror,BINNUM=BINNUM,INITVEL=initvel,nodispchi=nodispchi
...
wingesave='winge_templates_final.idl'
...
ppxf, convtemplates, galaxy, error, velScale, start, sol, $
    /PLOT, MOMENTS=4, DEGREE=4, VSYST=dv,WEIGHTS=weights,goodpix=goodpix,/clean;,/OVERSAMPLE
