@myfunct.pro
pro mask_skysubtract_r
  infile='../data/HST_10137_03_ACS_HRC_F606W_drz.fits'
  fits_read,infile, img, h
  imgsize=size(img,/dim)
  fits_read,infile,mask,exten_no=3
  mdrizz=[7.49002591447,8.24492204734,7.3641947003]
  expt=290.0
...
;  err=sqrt(img)
  ...
  writefits,'sky_mask_f606.fits',plane
