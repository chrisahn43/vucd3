PRO COMPARE_JAM_OUTPUT
  ...
  fixgauss_mass=mrdfits('fixgausspsf_mass.fits',2)
  fixnorm_mass=mrdfits('fixnormpsf_mass.fits',2)
  fixold_mass=mrdfits('fixoldpsf_mass.fits',2)
  freenorm_mass=mrdfits('freenormpsf_mass.fits',2)
  freenorm=mrdfits('freenormpsf.fits',2)
  fixnorm=mrdfits('fixnormpsf.fits',2)
 ...
 ;    temp=0D
  ...
  stop
  set_plot,'ps'
  device,filename='./full_fit_six/onedbestfit.ps',/color
  djs_plot,xbin,disp,psym=4,ytitle='Dispersion (km/s)',xtitle='Radius (arcseconds)',xran=[0.,0.8],yran=[25,55],/xsty,/ysty,charsize=1.5,charthick=4,xthick=3,ythick=3,symsize=2
  ...
  device,/close
  device,filename='./full_fit_six/cummulike.ps',/color
 ...
 ;    temp=0D
  ...
  device,/close
  device,filename='./full_fit_six/sigmambhs.ps',/color
