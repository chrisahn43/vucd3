...
;
  fits_read, 'psf_ngc2699.fits', img, h
;  img=img*(1./total(img))
;skylev = 0.55 ; counts/pixel
;img = img - skylev ; subtract sky
scale = 0.099972;0.0231 ; arcsec/pixel

ngauss = 12
minlevel = 0.;1e-6 ; counts/pixel
...
find_galaxy, img, majorAxis, eps, ang, xc, yc, FRACTION=.6, /PLOT
...
modelsig=sol[1,*]
modelweight=modelpeak/(2*!PI*(modelsig)^2)
forprint,modelpeak,modelsig,sol[2,*],format='F,F,F',textout='tinytim_fits.dat'
